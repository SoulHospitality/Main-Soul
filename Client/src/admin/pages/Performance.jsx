...
import { CalendarDays, Trophy, Users, ClipboardList } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="card p-5">
          ...
          <p className="mt-1 text-xs text-soul-muted">Created {fromDate} – {toDate}</p>
        </div>
        <div className="card p-5">
          <div className="flex items-center gap-3 text-soul-muted text-xs font-semibold uppercase tracking-wide">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <section className="card overflow-hidden">
          ...
          {!leaderboard.length ? (
            <EmptyState title="No team members yet" subtitle="Assign agents to this reservations manager in Users." />
          ) : (
        ...
        <section className="card overflow-hidden">
          <div className="px-5 py-4 border-b border-soul-line">
            <h2 className="font-semibold text-soul-blue">Daily reservations</h2>
            <p className="text-xs text-soul-muted mt-0.5">Bookings created each day in the selected range</p>
          </div>
          {!daily.length ? (
