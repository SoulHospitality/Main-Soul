...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="site-performance" element={<Navigate to="/admin/website-performance" replace />} />
      <Route path="booking-health" element={<Navigate to="/admin/website-performance" replace />} />
